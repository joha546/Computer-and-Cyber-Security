...
class SecureClientHandler:
    def __init__(self, client_socket, client_address, server_static_private_key, server_static_public_key):
    ...
    def accept_connections(self):
        while self.running:
            try:
                ...
                handler = SecureClientHandler(client_socket, client_address, self.server_signing_key, self.server_static_public_key)
